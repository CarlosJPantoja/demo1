...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      ...
      cy.get(`[data-cy="postalCode"]`).type('Humano Chalet Marketing').should('have.value', 'Humano Chalet Marketing');

      cy.get(`[data-cy="city"]`).type('Getafe Natalialand').should('have.value', 'Getafe Natalialand');
