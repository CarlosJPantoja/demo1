...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Susana').should('have.value', 'Susana');

      cy.get(`[data-cy="lastName"]`).type('Zepeda').should('have.value', 'Zepeda');

      cy.get(`[data-cy="email"]`).type('Felipe_Chvez41@hotmail.com').should('have.value', 'Felipe_Chvez41@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('Moda Sorprendente back-end').should('have.value', 'Moda Sorprendente back-end');

      cy.get(`[data-cy="hireDate"]`).type('2023-05-17T00:30').blur().should('have.value', '2023-05-17T00:30');
