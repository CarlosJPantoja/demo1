...
import co.edu.icesi.domain.Task;
import co.edu.icesi.repository.TaskRepository;
import co.edu.icesi.service.TaskService;
...
/**
 * REST controller for managing {@link co.edu.icesi.domain.Task}.
 */
@RestController
@RequestMapping("/api")
