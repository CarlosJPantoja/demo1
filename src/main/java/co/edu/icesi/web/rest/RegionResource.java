...
import co.edu.icesi.domain.Region;
import co.edu.icesi.repository.RegionRepository;
import co.edu.icesi.service.RegionService;
...
/**
 * REST controller for managing {@link co.edu.icesi.domain.Region}.
 */
@RestController
@RequestMapping("/api")
